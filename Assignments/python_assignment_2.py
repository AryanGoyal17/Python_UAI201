...
#q19
#Password attempts using while-else

#q20
#Point location using match-case
...
num_rows = int(input("Enter the number of rows you want in the triangle pattern: "))
...
for i in range(1, num_rows + 1):
    ...
    print() #This takes us to the next line without adding a extra newline...
